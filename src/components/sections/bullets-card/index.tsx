...
export function BulletsCard(props: Props) {
  return (
    <FadeInSection>
      <section
        id={props.id}
        className={`max-w-container md:mx-auto shadow-section bg-white rounded-xl mx-6 mb-8 md:mb-16 p-4 md:pt-12 md:px-16 md:pb-16 max-md:p-6 scroll-mt-[150px] max-lg:scroll-mt-[76px] ${props.className || ''}`}>
        ...
        <div className="grid gap-x-20 gap-y-3.5 grid-cols-1 md:grid-cols-2">
          {props.points.map((point) => (
            <div key={String(point)} className="flex items-center gap-8">
